              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate method="post"  action="{{ URL::to('update_project',['id'=>Crypt::encrypt($projects->project_code)])}}" enctype="multipart/form-data">
                      ...
                      <div class="item form-group {{ $errors->has('project_code') ?'has-error':'' }} ">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="project_code"   value="{{$projects->project_code}}" required="required"  placeholder="Project Code" disabled="disabled">
                    ...
                    @endif
                       ...
                       <div class="item form-group  {{ $errors->has('project_name') ?'has-error':'' }} ">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="project_name" value="{{$projects->project_name}}"  required="required"  placeholder="Project Name" disabled="disabled">
                     ...
                     <div class="item form-group {{ $errors->has('project_type_id') ?'has-error':'' }} ">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control" name="project_type_id" value="{{ old('project_type_id') }}" >
                            ...
                            <option value="{{$project_type->id}}" {{($projects->project_type->id == $project_type->id) ? 'selected' : '' }}>{{ $project_type->project_type_name }}</option>
                            @endforeach
                          </select>
                    ...
                    @endif
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="donar_name" value="{{$projects->donar_name}}"  required="required"  placeholder="Donar Name">
                    ...
                    @endif
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="date" class="form-control has-feedback-left" name="start_date"  value="{{$projects->start_date}}"placeholder="Start Date" aria-describedby="inputSuccess2Status2">
                    ...
                    @endif
                       ...
                       <div class="item form-group {{ $errors->has('end_date') ?'has-error':'' }} ">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="date" class="form-control has-feedback-left" name="end_date"  value="{{$projects->end_date}}" placeholder="End Date" aria-describedby="inputSuccess2Status2">
                          <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                                <span id="inputSuccess2Status2" class="sr-only">(success)</span>
                    ...
                    @endif
                       ...
                       <div class="item form-group  {{ $errors->has('project_cost') ?'has-error':'' }} ">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  name="project_cost" value="{{$projects->project_cost}}"  required="required" class="form-control col-md-7 col-xs-12" placeholder="Project Cost">
