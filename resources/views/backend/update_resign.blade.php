              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    {{ URL::to('update_resign',['id'=>Crypt::encrypt($resign->emp_id)])}}" enctype="multipart/form-data">	
                      ...
                      <div class="item form-group {{ $errors->has('emp_id') ?'has-error':'' }} ">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="emp_id" name="emp_id" value=" {{$resign->employee->first_name}} {{$resign->employee->last_name}}" required="required" data-validate-length-range="8,20" class="form-control col-md-7 col-xs-12" placeholder="Employee" disabled="disabled">
                        </div>
                      </div>
                        <div class="item form-group {{ $errors->has('resign_date') ?'has-error':'' }} ">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="date"  name="resign_date" value="{{ $resign->resign_date }}" required="required" data-validate-length-range="8,20" class="form-control col-md-7 col-xs-12" placeholder="Resign Date">
                    ...
                    <div class="item form-group {{ $errors->has('reason') ?'has-error':'' }} ">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="textarea">Reason <span class="required">*</span>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea id="textarea" required="required" name="reason" value="{{ old('reason') }}" class="form-control col-md-7 col-xs-12" placeholder="Reason">{{ $resign->reason}}</textarea>
