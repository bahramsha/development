        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate method="post"  action="{{ route('save_leave')}}" enctype="multipart/form-data">
                        ...
                        <div class="item form-group {{ $errors->has('request_date') ?'has-error':'' }} ">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="date"  name="request_date" value="{{ old('request_date') }}" required="required" data-validate-length-range="8,20" class="form-control col-md-7 col-xs-12" placeholder="Request Date">
                ...
                <div class="item form-group {{ $errors->has('date_start') ?'has-error':'' }} ">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="date"  name="date_start" value="{{ old('date_start') }}" required="required" data-validate-length-range="8,20" class="form-control col-md-7 col-xs-12" placeholder="Date Start">
            ...
            <div class="item form-group {{ $errors->has('date_end') ?'has-error':'' }} ">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="date"  name="date_end" value="{{ old('date_end') }}" required="required" data-validate-length-range="8,20" class="form-control col-md-7 col-xs-12" placeholder="Date End">
