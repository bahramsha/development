        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <!-- /.col-lg-12 -->
                  ...
                  <div class="row" >
                <div class="col-lg-12" >
                    <a href="{{ url('add_province') }}" class="btn btn-emp btn-info btn btn-success" role="button" > <i class="fa fa-plus"></i>
                        <b>Add New Province</b></a>
                  ...
                  <div class="x_content">
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped jambo_table bulk_action table-bordered">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title col-xs-2 text-center">Province Name</th>
                      ...
                      <div class="panel-heading"style="height: 105px;">{{ $provinces->links() }}</div>
                    </div>
